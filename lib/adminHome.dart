...
class adminHome extends StatefulWidget {
  ...
  bool check_url;
  adminHome(this.email,this.ipAddress,this.check_url);
  @override
...
class _adminHomeState extends State<adminHome>  with AutomaticKeepAliveClientMixin{
  ...
  String para_ip;
  update_emg_ip(String ip) async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString('emg_ip', ip);
              ...
              children: [
                ...
                InkWell(
                                  ...
                                  children: [
                                    TextField(
                                      decoration: InputDecoration(
                                          ...
                                          hintText: 'Tap to Change IP address'),
                                      onChanged: (String ip){
                                        setState(() {
                                          para_ip=ip;
                                        });
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.build,color: Colors.grey[700]),
                        SizedBox(width: 20,),
                        Text("Change IP",style: GoogleFonts.robotoSlab(color: Colors.grey[700]))
                      ],
                    ),
                  ),
                ),
