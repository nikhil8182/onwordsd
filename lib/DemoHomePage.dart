...
class DemoHome extends StatefulWidget {
  ...
  bool check_url;
  DemoHome(this.email,this.ipAddress,this.check_url);
  @override
          ...
          child: Drawer(
            child: ListView(
              ...
              children: [
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text("Demo user",style: GoogleFonts.robotoSlab(fontSize: 20,color: Colors.grey[700]),),
                        ],
                      ),
                    ],
                  ),
                ...
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>DemoWaterTank(widget.email)));
                  },
                  child: Container(
                    padding: EdgeInsets.all(10),
                    child: Row(
                ...
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>DemoAbout(widget.email)));
                  },
                  child: Container(
                    padding: EdgeInsets.all(10),
                    child: Row(
                    ...
                    child: GridView.builder(
                        ...
                        itemBuilder: (context,index){
                          return Padding(
                            ...
                            child: InkWell(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>DemoButtons(widget.email,name[index].toString(),index,widget.ipAddress,widget.check_url)));
                              },
                              child:Container (
